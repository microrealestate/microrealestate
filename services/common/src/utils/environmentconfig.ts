import type { EnvironmentValues } from '@microrealestate/shared';
...
const baseEnvironmentValues = {
  ...
  MONGO_URL: process.env.MONGO_URL || 'mongodb://localhost/demodb',
...
const keysToEscape: string[] = ['password', 'token', 'secret', 'cipher'];
