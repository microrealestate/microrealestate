...
const baseEnvironmentValues = {
  ...
  ACCESS_TOKEN_SECRET:
    ...
    process.env.AUTHENTICATOR_ACCESS_TOKEN_SECRET,
  REFRESH_TOKEN_SECRET:
    process.env.REFRESH_TOKEN_SECRET ||
    process.env.AUTHENTICATOR_REFRESH_TOKEN_SECRET,
  APPCREDZ_TOKEN_SECRET:
    process.env.APPCREDZ_TOKEN_SECRET ||
    process.env.AUTHENTICATOR_APPCREDZ_TOKEN_SECRET,
  RESET_TOKEN_SECRET:
    process.env.RESET_TOKEN_SECRET ||
    process.env.AUTHENTICATOR_RESET_TOKEN_SECRET,
